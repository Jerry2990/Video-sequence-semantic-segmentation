...
class GuidedSpatiallyVaryingConv(nn.Module):
    def __init__(self, in_class, freeze_bn=True, out_class=None, num_filter=16,
                 batch_norm=nn.BatchNorm2d, is_train_filter=False, is_edge=True):
        super().__init__()
        ...
        self.guide = GuidingNetwork(GN_in_channel, self.guide_filter, GN_out_channel, batch_norm, is_edge)
